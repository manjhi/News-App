...
public class TopHeadlinesAdapter extends RecyclerView.Adapter<TopHeadlinesAdapter.MyViewHolder> {
    ...
    public TopHeadlinesAdapter(List<NewsModel> newsModels, Context context,myclick myc) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final NewsModel news=newsModels.get(position);
...
//        Toast.makeText(context, "Position is:"+holder.getAdapterPosition(), Toast.LENGTH_SHORT).show();
