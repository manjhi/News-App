 ...
 */
public class Everthing extends Fragment {
    ...
    EverthingAdapter everthingAdapter;
    int x=0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_everthing, container, false);
...
//                    RecyclerView.LayoutManager linearLayoutManager=new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false);
    ...
    public void getNewsData() {
        ...
        Call<NewsModel> call = api.getEverthing();
        call.enqueue(new Callback<NewsModel>() {
            ...
            public void onResponse(Call<NewsModel> call, Response<NewsModel> response) {
                ...
                everthingAdapter = new EverthingAdapter(newsModels, getContext(), new EverthingAdapter.myclick() {
                    @Override
                ...
                everthingAdapter.notifyDataSetChanged();
                recyclerView.setAdapter(everthingAdapter);
