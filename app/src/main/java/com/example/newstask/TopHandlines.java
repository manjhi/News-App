 ...
 */
public class TopHandlines extends Fragment {
    ...
    TopHeadlinesAdapter recycleAdapter;
    int x=0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_top_handlines, container, false);
    ...
    public void getNewsData() {
        ...
        call.enqueue(new Callback<NewsModel>() {
            ...
            public void onResponse(Call<NewsModel> call, Response<NewsModel> response) {
                ...
                recycleAdapter = new TopHeadlinesAdapter(newsModels, getContext(), new TopHeadlinesAdapter.myclick() {
                    @Override
