...
public class SourceNewsAdapter extends RecyclerView.Adapter<SourceNewsAdapter.MyViewHolder> {
    ...
    public SourceNewsAdapter(List<NewsModel> newsModels, Context context,myclick myc) {
